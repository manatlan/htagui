...
# import htagui.bulma as ui             # ****KAPUTTT*******
# import htagui.shoelace as ui          # ****KAPUTTT*******
...
class App(ui.App):
    ...
    def init(self):
        OPTS = {1:"v1",2:"v2",3:"v3"}
        dynamics=[
            ui.IText("val",onchange=self.onchange),
            ui.ITextarea("val",onchange=self.onchange),
        ...
        statics=[
            ...
            Tag.Textarea("val",_onchange=self.onchange),
